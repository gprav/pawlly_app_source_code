      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            32.height,
            Text('${locale.value.weight} ${locale.value.lblIn} ${addPetInfoController.selectedWeightUnit.value.value})',
            ...
            32.height,
            Text('${locale.value.height} ${locale.value.lblIn} ${addPetInfoController.selectedHeightUnit.value.value})',
                    style: primaryTextStyle())
                .paddingSymmetric(horizontal: 16),
            8.height,
            Obx(
