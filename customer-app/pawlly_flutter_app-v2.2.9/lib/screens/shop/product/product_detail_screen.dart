        ...
        builder: (c) {
          return PopScope(
            ...
            onPopInvokedWithResult: (didPop, result) {
              if (!didPop) {
                Get.back(result: productDetailController
                                ...
                                children: [
                                  ...
                                  Obx(
                                    () => AppButton(
                                      ...
                                      disabledColor: productDetailController.selectedVariationData.value.isStockAvaible == 1 ? null : context.primaryColor.withValues(alpha: 0.8),
