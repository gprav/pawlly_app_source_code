...
class OrderDetailController extends GetxController {
  ...
  Rx<Future<OrderDetailModel>> getOrderDetailFuture =
      Future(() => OrderDetailModel(data: OrderListData(orderDetails: OrderDetails(productDetails: CartListData(qty: 0.obs, productVariation: VariationData(inCart: false.obs), productReviewData: ProductReviewDataModel()))))).obs;
  ...
  Future<void> deleteOrderReview() async {
    isLoading(true);
