...
class GroomingScreen extends StatelessWidget {
  ...
  GroomingScreen({super.key, this.isFromReschedule = false});
                          ...
                          () => AppTextField(
                            ...
                            decoration: inputDecoration(context,
                                ...
                                suffixIcon: groomingController.selectedService.value.serviceImage.isNotEmpty && groomingController.selectedService.value.id.isNegative
                                    ? Icon(Icons.keyboard_arrow_down_rounded, size: 24, color: darkGray.withValues(alpha: 0.5))
                                    : Icon(Icons.keyboard_arrow_down_rounded, size: 24, color: darkGray.withValues(alpha: 0.5))),
                  ...
                  onTap: () async {
                    if (groomingController.dateCont.text.trim().isEmpty) {
                      ...
                      TimeOfDay? pickedTime = await showTimePicker(
                        initialTime: TimeOfDay.fromDateTime(groomingController.bookGroomingReq.time.dateInHHmm24HourFormat),
                        context: context,
                      );
