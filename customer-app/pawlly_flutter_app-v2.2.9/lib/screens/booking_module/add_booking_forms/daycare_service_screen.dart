...
class DayCareScreen extends StatelessWidget {
  ...
  DayCareScreen({super.key, this.isFromReschedule = false});
      ...
      itemBuilder: (context, index) {
        return SettingItemWidget(
          ...
          onTap: () {
            ...
            currentSelectedService.value.serviceAmount = dayCareServiceController.selectedDayCareTaker.value.oneDayAmount;
            dayCareServiceController.bookDayCareReq.price = dayCareServiceController.selectedDayCareTaker.value.oneDayAmount;
                  ...
                  onTap: () async {
                    if (dayCareServiceController.dateCont.text.trim().isEmpty) {
                      ...
                      TimeOfDay? pickedTime = await showTimePicker(
                        initialTime: TimeOfDay.fromDateTime(dayCareServiceController.bookDayCareReq.dropOfftime.dateInHHmm24HourFormat),
                        context: context,
                      );
                ...
                AppTextField(
                  ...
                  onTap: () async {
                    if (dayCareServiceController.dateCont.text.trim().isEmpty) {
                      ...
                      TimeOfDay? pickedTime = await showTimePicker(
                        initialTime: TimeOfDay.fromDateTime(dayCareServiceController.bookDayCareReq.pickUptime.dateInHHmm24HourFormat),
                        context: context,
                      );
