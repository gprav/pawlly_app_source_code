                            ...
                            onTap: () async {
                              serviceCommonBottomSheet(
                                ...
                                onSheetClose: (p0) {
                                  ...
                                  boardingServiceController.getBoarders(searchtext: '');
                                },
                                child: Obx(
                          ...
                          AppTextField(
                            ...
                            onTap: () async {
                              TimeOfDay? pickedTime = await showTimePicker(
                                initialTime: TimeOfDay.fromDateTime(boardingServiceController.bookBoardingReq.dropoffTime.dateInHHmm24HourFormat),
                                context: context,
                              );
                          ...
                          AppTextField(
                            ...
                            onTap: () async {
                              if (boardingServiceController.dropOffDateCont.text.trim().isEmpty) {
                                ...
                                TimeOfDay? pickedTime = await showTimePicker(
                                  initialTime: TimeOfDay.fromDateTime(boardingServiceController.bookBoardingReq.pickupTime.dateInHHmm24HourFormat),
                                  context: context,
                                );
      ...
      itemBuilder: (context, index) {
        return SettingItemWidget(
          ...
          onTap: () {
            ...
            boardingServiceController.onDateTimeChanges();
            boardingServiceController.getBoarders();
            boardingServiceController.getFacilityList(employeeId: boardingServiceController.selectedBoarder.value.id, isBooking: 1);
            Get.back();
          },
        );
      },
                              ...
                              () => CheckboxListTile(
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      (element.createdBy == boardingServiceController.selectedBoarder.value.id) ? '${locale.value.providedBy} ${boardingServiceController.selectedBoarder.value.fullName}' : locale.value.providedByAdmin,
                                      style: secondaryTextStyle(color: primaryColor, fontStyle: FontStyle.italic),
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                    ),
                                  ],
