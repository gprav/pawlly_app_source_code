...
/**
 * Admin Panel Routes - Vendors Management
 * Accessible at /admin-panel/vendors
 */
Route::group(['prefix' => 'admin-panel', 'middleware' => ['auth']], function () {
    Route::group(['prefix' => 'vendors', 'as' => 'backend.vendors.'], function () {
        Route::get('/', [App\Http\Controllers\Backend\VendorController::class, 'index'])->name('index');
        Route::get('index_data', [App\Http\Controllers\Backend\VendorController::class, 'index_data'])->name('index_data');
        Route::get('{vendor}', [App\Http\Controllers\Backend\VendorController::class, 'show'])->name('show');
        Route::get('{vendor}/edit', [App\Http\Controllers\Backend\VendorController::class, 'edit'])->name('edit');
        Route::post('bulk_action', [App\Http\Controllers\Backend\VendorController::class, 'bulk_destroy'])->name('bulk_action');
        Route::post('{id}/update-status', [App\Http\Controllers\Backend\VendorController::class, 'updateStatus'])->name('update_status');
        Route::post('{id}/update-store-status', [App\Http\Controllers\Backend\VendorController::class, 'updateStoreStatus'])->name('update_store_status');
        Route::delete('{vendor}', [App\Http\Controllers\Backend\VendorController::class, 'destroy'])->name('destroy');
    });
});
