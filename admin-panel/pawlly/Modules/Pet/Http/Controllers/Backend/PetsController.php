...
class PetsController extends Controller
{
    ...
    public function index_list(Request $request)
    {
        ...
        if (isset($user_id)) {
            // Get pets owned by the user OR pets that have been booked by this user previously
            $data->where(function($query) use ($user_id) {
                $query->where('user_id', $user_id)
                      ->orWhereHas('bookings', function($q) use ($user_id) {
    ...
    public function index_data()
    {
        ...
        return Datatables::of($query)
            ...
            ->editColumn('gender', function ($data) {
                ...
                return $data->gender ? ucfirst($data->gender) : '-';
    ...
    public function store(PetsRequest $request)
    {
        ...
        $data['weight_unit'] = $request->weight_unit ? strtolower($request->weight_unit) : 'kg';
        $data['height_unit'] = $request->height_unit ? strtolower($request->height_unit) : 'cm';
