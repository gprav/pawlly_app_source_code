        ...
        <div class="right-data">
            ...
            <div class="collapse navbar-collapse header-right-panel" id="navbarSupportedContent">
                <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                    ...
                    @endif
                    <li class="nav-item theme-scheme-dropdown dropdown iq-dropdown me-3">
                    ...
                    <li class="nav-item dropdown iq-dropdown me-3">
                                ...
                                <div class="d-flex gap-2 align-items-center">
                                    ...
                                    <div class="d-flex flex-column align-items-start">
                                        <h6 class="m-0 text-primary">
                                            {{ Auth::user()->username ?? Auth::user()->full_name ?? default_user_name() }}</h6>
